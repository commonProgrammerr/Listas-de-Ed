...
public class ArvoreBinaria<T> implements TADArvore<T> {
	...
	private NodeBinario<T> raiz;
	
	public ArvoreBinaria() {
		this.raiz = null;
	}
	
	public ArvoreBinaria(NodeBinario<T> subTree) {
		this.raiz = subTree;
	}
	...
	private void removerRaizSubArvore(NodeBinario<T> raiz) {
	...
	public void inserir(T e) {
		if (! contains(e)) {
			NodeBinario<T> novo = new NodeBinario<T>(e);
			if (raiz == null) {
				raiz = novo;
			} else {
				NodeBinario<T> aux = raiz;
	...
	private void percursoPreOrdem(NodeBinario<T> no) {
		if (no != null) {
	...
	private void percursoPosOrdem(NodeBinario<T> no) {
		if (no != null) {
	...
	private void percursoEmOrdem(NodeBinario<T> no) {
		if (no != null) {
	...
	private void percursoEmOrdemDec(NodeBinario<T> no) {
		if (no != null) {
	...
	public NodeBinario<T> getRaiz() {
		return raiz;
	}
	
	public void setRaiz(NodeBinario<T> raiz) {
		this.raiz = raiz;
	}
