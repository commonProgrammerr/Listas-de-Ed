...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Testes questão 1\n");
		...
		System.out.println("Testes questão 8\n");
		...
		a.addDecolagem(new Aviao("Avião 1"));
		a.addDecolagem(new Aviao("Avião 2"));
		a.addDecolagem(new Aviao("Avião 3"));
		a.addEspera(new Aviao("Avião 4"));
		a.addEspera(new Aviao("Avião 5"));
		a.addEspera(new Aviao("Avião 6"));
		a.autorizaDecolagem();
		a.moveListas();
